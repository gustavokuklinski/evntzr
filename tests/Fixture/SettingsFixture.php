...
class SettingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'document' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-07-30 05:38:41',
                'updated' => '2019-07-30 05:38:41'
            ],
        ];
        parent::init();
    }
