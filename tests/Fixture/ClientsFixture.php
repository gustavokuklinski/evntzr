...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'transactionhash' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'payment' => 1,
                'transactionhash' => 'Lorem ipsum dolor sit amet',
                'created' => '2019-07-22 21:33:47',
                'modified' => '2019-07-22 21:33:47'
            ],
        ];
        parent::init();
    }
